                                ...
                                <td>
                                    <div style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">
                                            ...
                                            <form id="resetForm" action="/api/v1/reset-password/${id}" method="post" enctype="application/x-www-form-urlencoded">
                                                ...
                                                <button type="submit" style="display: inline-block; width: 95px; height: 40px; font-size: 20px; border-radius: 3px; background: #7e2e00; color: #ffffff; border: none; outline: none;">Submit</button>
                                            </form>
                                    ...
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                        <tr>
                                            <td style="text-align: left; padding-right: 10px;">
                                                <h3
                                                    style="color: #000; font-size: 20px; margin-top: 0; font-weight: 400;">
                                                    About</h3>
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                                <h3
                                                    ...
                                                    Contact Info</h3>
                                                <ul>
                                                    <li><span style="color: rgba(0,0,0,.5);">161/163 Muyibi street,Olodi
                                                            Apapa</span></li>
